...
const NoShop = () => {
  ...
  return (
    <div className="d-md-flex align-items-center no-shop">
      <div className="left">
        <h1 style={{fontSize: '3.5rem'}}>Créer votre <span className="d-block" style={{fontWeight: 700, color: 'rgb(75, 180, 180)'}}>boutique en ligne</span></h1>
